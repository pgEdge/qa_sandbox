...
\d sub_tx_table0
SELECT * FROM get_table_repset_info('sub_tx_table0'); -- Replication set: default
...
\d sub_tx_table3
SELECT * FROM get_table_repset_info('sub_tx_table3'); -- Replication set: default
...
\d sub_tx_table5
SELECT * FROM get_table_repset_info('sub_tx_table5'); -- Replication set: default_insert_only

\d sub_tx_table5a
SELECT * FROM get_table_repset_info('sub_tx_table5a'); -- Replication set: default
...
\d table_ctas2
SELECT * FROM get_table_repset_info('table_ctas2'); -- Replication set: default
-- Expected data: (3, 35)
...
\d table_ctas3
SELECT * FROM get_table_repset_info('table_ctas3'); -- Replication set: default
...
\d table_ctas6
SELECT * FROM get_table_repset_info('table_ctas6'); -- Replication set: default_insert_only
-- Expected data: 1
...
\d table_l2
SELECT * FROM get_table_repset_info('table_l2'); -- Replication set: default_insert_only
...
\d table_l3
SELECT * FROM get_table_repset_info('table_l3'); -- Replication set: default_insert_only
...
-- Expected: table exists with columns col1 (int, primary key), col2 (text)
\d table_l5
SELECT * FROM get_table_repset_info('table_l5'); -- Replication set: default
-- Expected data: (5, )
