...
-- Drop the materialized view in the s616 schema that depends on a view in the test_schema
DROP MATERIALIZED VIEW IF EXISTS s616.mv_depends_on_test_schema CASCADE;

-- Drop the view in the test_schema that depends on another view in the s616 schema
...
DROP VIEW IF EXISTS test_schema.view_test_1, 
                          ...
                          s616.view_test_default CASCADE;
