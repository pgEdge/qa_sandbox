...
CREATE SCHEMA IF NOT EXISTS s615;

GRANT ALL PRIVILEGES ON SCHEMA s615 TO appuser;
...
SELECT * FROM get_table_repset_info('product_catalog'); -- Expect product_catalog in default set
SELECT * FROM get_table_repset_info('employee_directory'); -- Expect employee_directory in default set
SELECT * FROM get_table_repset_info('sales_data'); -- Expect sales_data in default set
SELECT * FROM get_table_repset_info('concurrent_idx_tbl'); -- Expect sales_data in default set
