...
CREATE SCHEMA IF NOT EXISTS s611;

GRANT ALL PRIVILEGES ON SCHEMA s611 TO appuser;
...
\d sub_tx_table0
SELECT * FROM get_table_repset_info('sub_tx_table0'); --default repset
...
\d sub_tx_table0a
SELECT * FROM get_table_repset_info('sub_tx_table0a');
...
\d sub_tx_table1
SELECT * FROM get_table_repset_info('sub_tx_table1');
...
\d sub_tx_table4
SELECT * FROM get_table_repset_info('sub_tx_table4');
...
\d sub_tx_table5
SELECT * FROM get_table_repset_info('sub_tx_table5'); -- should be in default_insert_only set
\d sub_tx_table5a
SELECT * FROM get_table_repset_info('sub_tx_table5a'); -- should be in default
\d sub_tx_table5b
SELECT * FROM get_table_repset_info('sub_tx_table5b'); -- should not exist
\d sub_tx_table5c
SELECT * FROM get_table_repset_info('sub_tx_table5c'); -- should be in default_insert_only set
...
\d table_ctas1
SELECT * FROM get_table_repset_info('table_ctas1'); -- should be in default_insert_only set
...
\d table_ctas2
SELECT * FROM get_table_repset_info('table_ctas2'); -- should be in default set
...
\d table_ctas3
SELECT * FROM get_table_repset_info('table_ctas3'); -- should be in default set
...
\d table_ctas4
SELECT * FROM get_table_repset_info('table_ctas4'); -- should be in default_insert_only set
...
\d table_ctas5
SELECT * FROM get_table_repset_info('table_ctas5'); -- should be in default_insert_only set
...
\d table_ctas6
SELECT * FROM get_table_repset_info('table_ctas6'); -- should be in default_insert_only set
...
-- Validate table_si1
\d table_si1
SELECT * FROM get_table_repset_info('table_si1'); -- should be in default_insert_only set
...
-- Validate table_si2
\d table_si2
SELECT * FROM get_table_repset_info('table_si2'); -- should be in default_insert_only set
...
-- Validate table_si3
\d table_si3
SELECT * FROM get_table_repset_info('table_si3'); -- should be in default_insert_only set
...
-- Validate table_si4
\d table_si4
SELECT * FROM get_table_repset_info('table_si4'); -- should be in default_insert_only set
...
-- Validate table_si5
\d table_si5
SELECT * FROM get_table_repset_info('table_si5'); -- should be in default_insert_only set
...
\d table_l1
SELECT * FROM get_table_repset_info('table_l1'); -- should be in default_insert_only set
...
\d table_l2
SELECT * FROM get_table_repset_info('table_l2'); -- should be in default_insert_only set
...
\d table_l3
SELECT * FROM get_table_repset_info('table_l3'); -- should be in default_insert_only set
...
\d table_l4
SELECT * FROM get_table_repset_info('table_l4'); -- should be in default_insert_only set
...
\d table_l5
SELECT * FROM get_table_repset_info('table_l5'); -- should be in default set
