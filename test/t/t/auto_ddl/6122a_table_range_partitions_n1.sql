...
CREATE SCHEMA IF NOT EXISTS s612;

GRANT ALL PRIVILEGES ON SCHEMA s612 TO appuser;
...
SELECT * FROM get_table_repset_info('sales_range'); -- Expect both parent and child tables in default set
...
SELECT * FROM get_table_repset_info('revenue_range'); -- Expect both parent and child tables in default_insert_only set
...
\d+ sales_range_2023
SELECT * FROM get_table_repset_info('sales_range'); -- Expect sales_range_2023 in default set
...
SELECT * FROM get_table_repset_info('revenue_range'); -- Expect revenue_range and all child partitions to move to default set
...
SELECT * FROM get_table_repset_info('revenue_range'); -- Expect revenue_range_2023 in default set
...
-- Validate structure and data
SELECT * FROM get_table_repset_info('orders_range'); -- Expect both parent and child tables in default set
SELECT * FROM orders_range ORDER BY order_id; -- Expect 2 rows 

-- Drop a partition
ALTER TABLE sales_range DETACH PARTITION sales_range_2023;
SELECT * FROM get_table_repset_info('sales_range'); --should still have the repset assigned
DROP TABLE sales_range_2023;
SELECT * FROM get_table_repset_info('sales_range'); -- validate sales_range_2023 to be removed 
...
-- Validate structure and data
SELECT * FROM get_table_repset_info('inventory_range'); -- Expect both parent and child tables in default set
...
-- Validate structure and data
SELECT * FROM get_table_repset_info('inventory'); -- Expect inventory_standalone to be listed
